...
const AfricaMap = () => {
  ...
  const handleCountryHoverEnd = (event) => {
    event.target.style.fill = "#99d8c9"; // Reset the fill color when not hovering
    setTooltipText("");
  };

  const handleCountryClick = (countryName) => {
    // Open a link or perform any other action when clicked
      ...
      <div className="svgContainer">
        ...
        >
          ...
          <path
            ...
            d="m359.3611 529.05186-15.311 2.049-7.908-61.994c-1.011-4.727-5.704-6.821-9.287-9.71l1.899-10.132 9.921-7.81 10.343.422 7.599-12.242 17.097 2.744.106 13.556c4.85 5.211 3.97 12.205.312 14.397.334 6.527-.856 11.939-5.194 11.793-2.627 7.06-4.868 15.535-8.611 18.502l-.966 38.425z"
            onMouseEnter={(event) => handleCountryHover(event, "Benin")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Benin")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Burkina_Faso")}
            onMouseLeave={(event) =>
              handleCountryHoverEnd(event, "Burkina_Faso")
            }
            onClick={() => handleCountryClick("Burkina_Faso")}
            cursor="pointer"
          />
          <path
            id="Elfenbeinkueste"
            ...
            onMouseEnter={(event) =>
              handleCountryHover(event, "Elfenbeinkueste")
            }
            onMouseLeave={(event) =>
              handleCountryHoverEnd(event, "Elfenbeinkueste")
            }
            onClick={() => handleCountryClick("Elfenbeinkueste")}
            cursor="pointer"
          />
          <path
            id="Gambia"
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Gambia")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Gambia")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Ghana")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Ghana")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Guinea")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Guinea")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Guinea-Bissau")}
            onMouseLeave={(event) =>
              handleCountryHoverEnd(event, "Guinea-Bissau")
            }
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Kamerun")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Kamerun")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Liberia")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Liberia")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Mali")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Mali")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Niger")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Niger")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Nigeria")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Nigeria")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Senegal")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Senegal")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Sierra_Leone")}
            onMouseLeave={(event) =>
              handleCountryHoverEnd(event, "Sierra_Leone")
            }
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Togo")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Togo")}
          ...
          <g id="g4863">
            <path
              ...
              onMouseEnter={(event) => handleCountryHover(event, "Mauretanien")}
              onMouseLeave={(event) =>
                handleCountryHoverEnd(event, "Mauretanien")
              }
            ...
            <path
              ...
              id="Chad"
              onMouseEnter={(event) => handleCountryHover(event, "Chad")}
              onMouseLeave={(event) => handleCountryHoverEnd(event, "Chad")}
          ...
          <path
            ...
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Ethiopia")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Eritrea")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Eritrea")}
          ...
          <path
            ...
            onMouseEnter={(event) => handleCountryHover(event, "Somalia")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Somalia")}
          ...
          <path
            ...
            d="m 893.90625,240.4375 -5.4375,5.53125 -4.46875,-1 -2.09375,9.03125 -9.65625,2.53125 -0.875,7.34375 -8.53125,0.96875 -4.0625,-4.25 -132.09375,4 1.59375,33.09375 c -5.616,0.426 -11.40675,0.4425 -15.96875,-0.1875 l 0.25,10.53125 1.53125,62.59375 -17.90625,0.96875 0.21875,6.6875 -10.25,12.96875 0.65625,9.21875 -3.4375,1.5625 c -0.328,5.757 -0.98825,10.799 -3.40625,12.375 l 0.125,7.46875 7.46875,-1.5625 c 1.503,8.384 1.86925,17.1905 8.90625,23.5625 l 0.90625,5.59375 -3.34375,0.46875 c 5.641,7.021 12.14975,13.59975 15.84375,21.59375 -6.26995,19.41937 2.64474,16.68638 8.0625,19.0625 l 0.0313,-0.28125 14.53125,-28.4375 8,0 5.5,0 4.5,8.625 6.5,-0.625 19.5625,0 0,-7.375 L 797,463.15625 797.15625,469 806.5,466 l 0,-5.6875 10.6875,-3.9375 L 833.34375,467 850.5,445 l -1,-13.875 -5.9375,-4.4375 11.4375,0 0,-5.6875 6.5,2.625 6.03125,33.53125 L 875,460 l 4.46875,8.5 0,11.78125 7.71875,-2.84375 0.0313,0 -0.25,-20.40625 5.03125,-7.46875 5.09375,0.0625 2.5,-12.90625 c 6.034,-7.425 8.40475,-16.94525 18.09375,-22.28125 l 3.0625,-24.40625 c -1.764,-17.227 3.47075,-32.09925 5.96875,-47.90625 2.495,-1.027 5.347,0.86675 7.375,-3.90625 L 945.25,332.5625 c 2.201,-1.466 2.94675,-4.9005 3.59375,-8.4375 -1.513,-3.379 -3.6815,-2.7685 -5.6875,-3.1875 -3.293,-6.326 -8.757,-6.88275 -13.5,-9.34375 l -6.625,-40.09375 -5.25,-5.5625 c 1.34,-14.368 -15.576,-16.916 -23.875,-25.5 z"
            onMouseEnter={(event) => handleCountryHover(event, "Sudan")}
            onMouseLeave={(event) => handleCountryHoverEnd(event, "Sudan")}
